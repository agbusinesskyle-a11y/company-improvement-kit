...
**0.1.0-alpha.24 — public skill and documentation preview.** The complete automation
...
is source-verified with distinct worker grants and a disabled five-stage host cycle
configured privately. Publisher credential verification and a fresh owner approval
